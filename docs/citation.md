...
PyWatson is inspired by
[DrWatson.jl](https://github.com/JuliaDynamics/DrWatson.jl) for the
Julia language. If DrWatson.jl was useful in your work, please also consider
citing it:
